...
function CurveCard() { 
    ...
    const sizeOptions = [
        { value: '348', label: '1 كارت كيرف (5.50 - 9.00 cm)' },
        { value: '349', label: '2 كارت كيرف (11.00 - 9.00 cm)' },
        { value: '350', label: '3 كارت كيرف (16.50 - 9.00 cm)' },
        { value: '351', label: '4 كارت كيرف (11.00 - 18.00 cm)' },
    ];

    const cutShapeOptions = [
        { value: '495', label: 'كارت شخصى 2 كيرف', image: 'https://www.tantawy-print.com/uploads/options_values/source/25904.jpeg' },
        { value: '496', label: 'كارت شخصى 4 كيرف', image: 'https://www.tantawy-print.com/uploads/options_values/source/36344.jpeg' },
        { value: '497', label: 'كارت شخصى 2 كيرف', image: 'https://www.tantawy-print.com/uploads/options_values/source/33591.jpeg' },
    ];
    ...
    const formatOptionLabel = ({ label, image }) => (
        <div style={{ display: 'flex', flexDirection:'column', alignItems: 'center' }}>
             <span>{label}</span>
            {image && <img src={image} alt="" style={{ width:'90%', height: 160, marginRight: 60 }} />} 
        </div>
    );
                    ...
                    <div className='d-lg-flex col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-1'>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="mb-3">
                                ...
                                <span className="navigation-pipe">&gt;</span> كارت كيرف
                            </div>
                            <div id="image-block" className="clearfix">
                                <span id="view_full_size">
                                <ImageZoom src="https://www.tantawy-print.com/uploads/products/resize800/91904.png" alt="كارت كيرف" />
                                </span>
                            </div>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-5">
                            <h5>
                                <div className="star_content float-left">
                                    <input type="hidden" name="" value="5.0000" />
                                    <div className="review-rating" data-rate="5"></div>
                                </div>
                                كارت كيرف
                            </h5>
                            <span></span>
                            ...
                            <div className='mt-4'>
                                ...
                                <div className="col-xs-12 col-sm-12 col-md-12">
                                    <div className='d-flex'>
                                        <label className="col-sm-4 col-md-4 col-xs-4 col-4 text-danger fw-bold">المقاس المطلوب :&nbsp;</label>
                                        <div className="form-group col-xs-8 col-sm-8 col-md-8 col-8">
                                            <input type="text" className="form-control" value={customSize} onChange={(e) => setCustomSize(e.target.value)} required />
                                        </div>
                                    </div>
                                    <p className={`${style.pfont} mt-3`}>فى حالة عدم توافر مقاس الكارت المطلوب برجاء التواصل مع المطبعة</p>
                                </div>
                                ...
                                <div className="col-xs-12 col-sm-12 col-md-12">
                                <div className='d-flex'>
                                        <label className="col-4 text-danger fw-bold">شكل القص للكارت :&nbsp;</label>
                                        <div className="form-group col-xs-12 col-sm-8 col-md-8 col-8">
                                            <Select
                                                ...
                                                isClearable
                                                isSearchable
                                                onChange={(selectedOption) => setCutShape(selectedOption)}
                                            />
                                        </div>
                                    </div>
