...
function MattLargeCard() { 
    ...
    const sizeOptions = [
        { value: "352", label: "1 كارت مط كبير بدون كيرف(5.50 - 9.00 cm)" },
        { value: "353", label: "2 كارت مط كبير بدون كيرف(11.00 - 9.00 cm)" },
        { value: "354", label: "3 كارت مط كبير بدون كيرف(16.50 - 9.50 cm)" },
        { value: "355", label: "4 كارت مط كبير بدون كيرف(11.00 - 18.00 cm)" }
    ];
                    ...
                    <div className='d-lg-flex col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-1'>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="mb-3">
                                ...
                                <span className="navigation-pipe">&gt;</span> كارت مط كبير بدون كيرف
                            </div>
                            <div id="image-block" className="clearfix">
                                <span id="view_full_size">
                                <ImageZoom src="https://www.tantawy-print.com/uploads/products/source/64745.jpeg" alt="كارت كيرف" />
                                </span>
                            </div>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-5">
                            <h5>
                                ...
                                كارت مط كبير بدون كيرف
                            </h5>
                            <span></span>
                            <hr />
                            <p>كارت مط كبير بدون كيرف </p>
                        ...
                        <section id="tm-tabcontent" className="">
                            ...
                            <div className="tab-content">
                                <ul id="" className="tab-pane border p-4 active">
                                    <li>
                                        <p><strong> كارت مط كبير بدون كيرف </strong></p>
                                        كارت مط كبير بدون كيرف
                                    </li>
                                </ul>
                            </div>
