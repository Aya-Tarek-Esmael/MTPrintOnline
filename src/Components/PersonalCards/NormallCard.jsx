...
function NormallCard() { 
    ...
    const sizeOptions = [
            { value: "332", label: "1 كارت عادى (5.00 - 8.50 cm)" },
            { value: "333", label: "2 كارت عادى (10.00 - 8.50 cm)" },
            { value: "334", label: "3 كارت عادى (15.00 - 8.50 cm)" },
            { value: "335", label: "4 كارت عادى (10.00 - 17.00 cm)" }
        ];
                    ...
                    <div className='d-lg-flex col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-1'>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="mb-3">
                                ...
                                <span className="navigation-pipe">&gt;</span> كارت عادي
                            </div>
