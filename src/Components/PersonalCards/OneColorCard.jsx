...
function OneColorCard() { 
    ...
    const sizeOptions = [
            { value: "336", label: "1 كارت عادى بظهر (5.00 - 8.50 cm)" },
            { value: "337", label: "2 كارت عادى بظهر (10.00 - 8.50 cm)" },
            { value: "338", label: "3 كارت عادى بظهر (15.00 - 8.50 cm)" },
            { value: "339", label: "4 كارت عادى بظهر (10.00 - 17.00 cm)" }
        ];
                    ...
                    <div className='d-lg-flex col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-1'>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="mb-3">
                                ...
                                <span className="navigation-pipe">&gt;</span> كارت عادي بظهر واحد لون
                            </div>
                            <div id="image-block" className="clearfix  border ms-4">
                                <span id="view_full_size">
                                <ImageZoom src="https://www.tantawy-print.com/uploads/products/resize800/28758.jpeg"  className='' alt="كارت كيرف" />
                                </span>
                            </div>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-5">
                            <h5>
                                ...
                                كارت عادي بظهر واحد لون
                            </h5>
                            <span></span>
                            <hr />
                            <p>كارت عادي بظهر واحد لون</p>
                        ...
                        <section id="tm-tabcontent" className="">
                            ...
                            <div className="tab-content">
                                <ul id="" className="tab-pane border p-4 active">
                                    <li>
                                        <p><strong> كارت عادي بظهر واحد لون</strong></p>
                                        كارت عادي بظهر واحد لون
                                    </li>
                                </ul>
                            </div>
