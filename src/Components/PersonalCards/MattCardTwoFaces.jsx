...
function MattCardTwoFaces() { 
    ...
    const sizeOptions = [
            { value: "332", label: "1 كارت مط وجهين (5.00 - 8.50 cm)" },
            { value: "333", label: "2 كارت مط وجهين (10.00 - 8.50 cm)" },
            { value: "334", label: "3 كارت مط وجهين (15.00 - 8.50 cm)" },
            { value: "335", label: "4 كارت مط وجهين (10.00 - 17.00 cm)" }
        ];
                    ...
                    <div className='d-lg-flex col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-1'>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="mb-3">
                                ...
                                <span className="navigation-pipe">&gt;</span> كارت مط وجهين 
                            </div>
                            <div id="image-block" className="clearfix">
                                <span id="view_full_size">
                                <ImageZoom src="https://www.tantawy-print.com/uploads/products/source/72396.jpeg" alt="كارت كيرف" />
                                </span>
                            </div>
                        ...
                        <section id="tm-tabcontent" className="">
                            ...
                            <div className="tab-content">
                                <ul id="" className="tab-pane border p-4 active">
                                    <li>
                                        <p><strong> كارت مط وجهين </strong></p>
                                        كارت مط وجهين 
                                    </li>
                                </ul>
                            </div>
...
export default MattCardTwoFaces;
