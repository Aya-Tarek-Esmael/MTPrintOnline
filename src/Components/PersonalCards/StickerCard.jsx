...
function StickerCard() { 
    ...
    const sizeOptions = [
            { value: "332", label: "1 كارت ستيكر (5.00 - 8.50 cm)" },
            { value: "333", label: "2 كارت ستيكر (10.00 - 8.50 cm)" },
            { value: "334", label: "3 كارت ستيكر (15.00 - 8.50 cm)" },
            { value: "335", label: "4 كارت ستيكر (10.00 - 17.00 cm)" }
        ];
                    ...
                    <div className='d-lg-flex col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-1'>
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <div className="mb-3">
                                ...
                                <span className="navigation-pipe">&gt;</span> كارت ستيكر
                            </div>
                            <div id="image-block" className="clearfix">
                                <span id="view_full_size">
                                <ImageZoom src="https://www.tantawy-print.com/uploads/products/source/53865.jpeg" alt="كارت كيرف" />
                                </span>
                            </div>
