...
function BannerProDetailsSeeThrough() {
    const {id} =useParams();
    ...
    async function getProDetails() {
      let { data } = await axios.get(`https://mtb3a.arabiangeeks.net/api/products/14/details`);
      console.log(data);
      setProDetails(data);
    }
    ...
    >
      ...
      />
                ...
                <div className="col-md-5 px-4 mt-5 ">
                    ...
                    <p style={{'fontSize':'13px'}} > طباعة وتركيب سي ثرو بجميع المقاسات. السعر يشمل التصميم والطباعة</p>
                  ...
                  <small className="d-none">(الحد الأقصى لحجم الملف 512 ميغابايت)</small>
                                ...
                                {/*  */}
                                    ...
                                    <div className='d-flex  justify-content-between py-1 '>
                                     <div className='col-6'>
                                     <div className="text-danger">x <span>{quantity}</span> <span className='fw-bold'>سي ثرو</span></div>
                                     </div>
                                     <div>
                                ...
                                <div className="d-flex w-100 mt-4">
                                    <div className="quantity col-4 mt-2">
                                        <label className="screen-reader-text d-none" htmlFor="quantity">كمية سي ثرو</label>
                    <input
                        type="number"
                        id="quantity"
...
export default BannerProDetailsSeeThrough