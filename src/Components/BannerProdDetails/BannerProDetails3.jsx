                     ...
                     <h5 className="fw-normal mt-4" data-addon-name="أكتب ملاحظاتك مع الطلب">أكتب ملاحظاتك مع الطلب</h5>
                                ...
                                <div className="d-flex w-100">
                                    <div className="quantity col-12 ">
                                        <label className=" mb-3 mt-2  w-100 d-flex  justfy-content-between" htmlFor="quantity">
                                            <strong className='col-6 ms-4'>  <span>كمية  </span>   بانر عاكس  </strong>
                                            <strong className='col-6 mx-5'>  <span>كمية  </span>    0.00 EGP  </strong>
                                            </label>
                                           <div className='text-center border-top py-3'>
                                           <strong className='col-12 text-danger text-center'> <span>المجموع </span> 0.00 EGP  </strong>
                                           </div>

                                           <div className='d-flex'> <input
                                            type="number"
                                            id="quantity"
                                            className={` col-3 border-1  mt-2 py-1 rounded text-center ${style.quantity}`}
                                            name="quantity"
                                            defaultValue="1"
                                            title='quantity'
                                            ...
                                            placeholder=""
                                            autoComplete="off"
                                            style={{'fontSize': '1.1rem','height':'46px'}}
                                            {...register('quantity')}
                                        />
                                    <button type="submit" className="btn btn-danger col-9 mt-2 mb-5 py-2 fs-5 me-1">إضافة إلى السلة</button></div>
...
export default BannerProDetails3