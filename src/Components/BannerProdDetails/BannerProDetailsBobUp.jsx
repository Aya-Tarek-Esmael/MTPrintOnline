...
function BannerProDetailsBobUp() {
  ...
  const [selectedFile, setSelectedFile] = useState(null);
    ...
    async function getProDetails() {
      let { data } = await axios.get(`https://mtb3a.arabiangeeks.net/api/products/6/details`);
      console.log(data)
      console.log(data)
      setProDetails(data);
                  ...
                  <small className="d-none">(الحد الأقصى لحجم الملف 512 ميغابايت)</small>
                                ...
                                <div className="d-flex w-100 mt-4">
                                    <div className="quantity col-4 mt-2">
                                        <label className="screen-reader-text d-none" htmlFor="quantity">كمية بوب اب</label>
                    <input
                        type="number"
                        id="quantity"
