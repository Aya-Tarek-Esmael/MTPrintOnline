...
function BannerProDetailsWallPaper() {
    const { id } = useParams();
    ...
    return (
        <div>
            {proDetails ? (
                <div className={`container-fluid mb-3 pb-4 ${style.containerbg}`}>
                    <div className="row px-5 mx-auto">
                        ...
                        <div className="col-md-5 px-4 mt-5 ">
                            ...
                            <p style={{ 'fontSize': '13px' }}>السعر يشمل التصميم والطباعة. يعطي شكل ثلاثي الأبعاد و غني بالألوان السعر شامل طبقة سلفان للحماية</p>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className='d-flex justify-content-between py-1'>
                                    <div className='col-6'>
                                        <div className="text-danger">x <span>{quantity}</span> <span className='fw-bold'>{proDetails.name}</span></div>
                                    </div>
                                    <div>
                                        <span className='col-6 mx-3 text-danger fw-bold'>{price ? `${(price * quantity).toFixed(2)} EGP` : '0.00 EGP'}</span>
                                    </div>
                                </div>
                                ...
                                <div className='text-danger text-center col-12 mt-3 py-3 border-top border-bottom fs-4'>المجموع EGP {price ? `${(price * quantity).toFixed(2)}` : '0.00'}</div>
                                <div className="d-flex w-100 mt-4">
                                    <div className="quantity col-4 mt-2">
                                        <label className="screen-reader-text d-none" htmlFor="quantity">كمية ورق حائط</label>
                                        <input
                                            type="number"
                                            id="quantity"
...
export default BannerProDetailsWallPaper;
