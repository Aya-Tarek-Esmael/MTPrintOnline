...
import style from './Acrylic.module.css'
...
function Acrylic() {
  ...
  const [price, setPrice] = useState(0.00);
    ...
    const handleSubmit = (e) => {
        ...
        console.log('Selected Press Type:', pressType);
  ...
  const calculateTotalPrice = () => {
    ...
    useEffect(() => {
        // calculateTotalPrice();
        setPrice();
      }, [pressPrice,sidePrice, pressType, sideType,oneFaceColor, lightColor]);
  ...
  return (
    ...
    <h1 className='mx-4 mb-5'>اكليرك × اكليرك </h1>
