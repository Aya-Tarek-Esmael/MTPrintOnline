...
import style from './Face2ColorsxAcrylic.module.css'
...
function Face2ColorsxAcrylic() {
  ...
  const [price, setPrice] = useState(0.00);
    ...
    const handleSubmit = (e) => {
        ...
        console.log('Selected twofaceColor:', twoFaceColor);
  ...
  const calculateTotalPrice = () => {
    ...
    useEffect(() => {
        // calculateTotalPrice();
        setPrice();
      }, [sidePrice, oneFaceColor,twoFaceColor, sideType, lightColor]);
  ...
  return (
    ...
    <h1 className='mx-4 mb-5'> اكليرك "الوش 2 لون"×اكليرك   </h1>
...
export default Face2ColorsxAcrylic
