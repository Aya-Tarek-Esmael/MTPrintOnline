...
function PrintAndCut({data}) {
 ...
 <li className={`card ${style.product}  border-0 pb-3 mt-3 mb-5 col-lg-3 col-md-3 col-sm-12  col-xs-12 `}>
	<div className="">
        <Link to={`/printandcut/`} title="flex" className={style.cardimg}>
			...
			<div className="cardheader text-center">				
				<div className="">
					...
					<Link to="" className='text-dark '>منتجات الطباعة</Link>
						...
						<div className="mb-3">
					<Link to={`/glossy/`} aria-label="flex" className="text-dark fs-4 fw-bold ">برنت اند كات</Link>
