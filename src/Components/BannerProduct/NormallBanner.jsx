			...
			<div className="cardheader text-center">				
				<div className="">
					...
					<Link to="" className='text-dark '>منتجات الطباعة</Link>
						...
						<div className="mb-3">
					<Link to={`/بانر-عادي/`} aria-label="بانر-عادي" className="text-dark fs-4 fw-bold ">بانر عادي</Link>
...
<Link to={`/بانر-عادي/`} className={` text-light border-0 ${style.cardbtn} rounded border border-danger mt-3 w-100  btn main-btn width-fluid text-center align-items-center `}  aria-label="تحديد الخيارات لـ &quot;بانل عادي&quot;" aria-describedby="هناك العديد من الأشكال المختلفة لهذا المنتج. يمكن اختيار الخيارات على صفحة المنتج">حدد ابعاد المنتج
</Link>
</div>
</li>
