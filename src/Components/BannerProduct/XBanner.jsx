...
function XBanner({data}) {
  return (
	...
	<div className="">
        <Link to={`/اكس-بانر/`} title="اكس بانر" className={style.cardimg}>
			...
			<div className="cardheader text-center">				
				<div className="">
					...
					<Link to="" className='text-dark '>منتجات الطباعة</Link>
						...
						<div className="mb-3">
					<Link to={`/اكس-بانر/`} aria-label="اكس بانر" className="text-dark fs-4 fw-bold ">اكس بانر</Link>
...
<Link to={`/اكس-بانر/`} className={` text-light border-0 ${style.cardbtn} rounded border border-danger mt-3 w-100  btn main-btn width-fluid text-center align-items-center `}  aria-label="تحديد الخيارات لـ &quot;اجستبل استاند&quot;" aria-describedby="هناك العديد من الأشكال المختلفة لهذا المنتج. يمكن اختيار الخيارات على صفحة المنتج">تحديد أحد الخيارات
</Link>
</div>
</li>
