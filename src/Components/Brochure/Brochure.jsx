           ...
           <div className='col-lg-8 d-lg-flex  px-4'>
            <div className='col-md-6 ms-1 col-sm-12 px-sm-1'>
              ...
              <div className='d-flex mt-1 me-0 col-12 text-center '>
                <div className={`border hovercolor  col-3 py-2 ${style.textfont}`}>كوشيه 115 جرام</div>
                <div className={`border me-1 hovercolor  col-3  py-2 ${style.textfont}`}>كوشيه 200 جرام</div>
                <div className={`border me-1 hovercolor   col-3 py-2 ${style.textfont}`}>كوشيه 250 جرام</div>
                <div className={`border me-1 hovercolor col-3 py-2 ${style.textfont}`}>كوشيه 300 جرام</div>
              </div>
              </div>
               {/* item */}
               <div className='mt-3'>
              ...
              <div className='d-flex text-center '>
                <div className='border col-6 p-1 hovercolor'>وجه واحد</div>
                <div className='border me-1 col-6 p-1 hovercolor'>وجهين</div>
              </div>
              </div>
              {/* item */}
              <div className='mt-3'>
              ...
              <div className='border  col-6 p-1 hovercolor '>A3 (30 X 42)</div>
             <div className='border me-1  col-6 p-1 hovercolor'>A4 (21 X 30)</div>
              ...
              <div className='d-flex text-center ms-1'>
                <div className='border   col-4 p-1 hovercolor'> بدون إنثناء</div>
                <div className='border  me-1  col-4 p-1 hovercolor'>ثنائى</div>
                <div className='border  me-1  col-4 p-1 hovercolor'>ثلاثى</div>
              </div>
              </div>
               {/* item */}
               <div className='mt-2'>
